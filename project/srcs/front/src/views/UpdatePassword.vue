...
import type { RecoverPasswordIn } from '@/types/auth'
...
const handlePasswordNew = async () => {
  ...
  try {
    ...
    const payload : RecoverPasswordIn = { 
...
<template>
        <Card title="New Password">
            ...
            <Input type="password" name="password_conf" label="Confirm password" id="password_conf" v-model="userPasswordConf" />
            <div class="btn" style="display: flex;flex-direction: column; gap: 2px;padding: 6px;">
                <Button text="Confirm Password" @click="handlePasswordNew"  style="background-color: #9566B0;"></Button>
            </div>
